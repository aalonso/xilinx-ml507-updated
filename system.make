...
# /home/aalonso/workspace/xlnx/xilinx-ml507-updated/system.mhs
# The software specification of the system is in file :
# /home/aalonso/workspace/xlnx/xilinx-ml507-updated/system.mss
...
TestApp_wbEncoder_program: $(TESTAPP_WBENCODER_OUTPUT) 

$(TESTAPP_WBENCODER_OUTPUT) : $(TESTAPP_WBENCODER_SOURCES) $(TESTAPP_WBENCODER_HEADERS) $(TESTAPP_WBENCODER_LINKER_SCRIPT) \
                    $(LIBRARIES) __xps/testapp_wbencoder_compiler.opt
	@mkdir -p $(TESTAPP_WBENCODER_OUTPUT_DIR) 
	$(TESTAPP_WBENCODER_CC) $(TESTAPP_WBENCODER_CC_OPT) $(TESTAPP_WBENCODER_SOURCES) -o $(TESTAPP_WBENCODER_OUTPUT) \
	$(TESTAPP_WBENCODER_OTHER_CC_FLAGS) $(TESTAPP_WBENCODER_INCLUDES) $(TESTAPP_WBENCODER_LIBPATH) \
	$(TESTAPP_WBENCODER_CFLAGS) $(TESTAPP_WBENCODER_LFLAGS) 
	$(TESTAPP_WBENCODER_CC_SIZE) $(TESTAPP_WBENCODER_OUTPUT) 
	@echo ""

TestApp_wbEncoder_programclean:
	rm -f $(TESTAPP_WBENCODER_OUTPUT) 
...
$(SYSTEM_ACE): $(DOWNLOAD_BIT) $(TESTAPP_MEMORY_PPC440_0_OUTPUT) $(TESTAPP_PERIPHERAL_PPC440_0_OUTPUT) $(TESTAPP_PERIPHERAL_PPC440_0_TFT_OUTPUT) $(TESTAPP_WBENCODER_OUTPUT) 
	@echo "*********************************************"
	@echo "Creating system ace file"
	@echo "*********************************************"
	xmd -tcl genace.tcl -jprog -hw $(DOWNLOAD_BIT) -elf $(TESTAPP_MEMORY_PPC440_0_OUTPUT) $(TESTAPP_PERIPHERAL_PPC440_0_OUTPUT) $(TESTAPP_PERIPHERAL_PPC440_0_TFT_OUTPUT) $(TESTAPP_WBENCODER_OUTPUT)  -target ppc_hw  -ace $(SYSTEM_ACE)
