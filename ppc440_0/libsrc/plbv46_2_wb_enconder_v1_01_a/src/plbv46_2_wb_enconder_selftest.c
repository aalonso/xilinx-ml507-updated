/*****************************************************************************
* Filename:          /home/aalonso/workspace/ppc44x/xilinx-ml507-updated/drivers/plbv46_2_wb_enconder_v1_01_a/src/plbv46_2_wb_enconder_selftest.c
* Version:           1.01.a
* Description:       Contains a diagnostic self-test function for the plbv46_2_wb_enconder driver
...
XStatus PLBV46_2_WB_ENCONDER_SelfTest(void * baseaddr_p)
{
  ...
  PLBV46_2_WB_ENCONDER_mWriteSlaveReg0(baseaddr, 0, 1);
  Reg32Value = PLBV46_2_WB_ENCONDER_mReadSlaveReg0(baseaddr, 0);
  ...
  PLBV46_2_WB_ENCONDER_mWriteSlaveReg1(baseaddr, 0, 2);
  Reg32Value = PLBV46_2_WB_ENCONDER_mReadSlaveReg1(baseaddr, 0);
  ...
  PLBV46_2_WB_ENCONDER_mWriteSlaveReg2(baseaddr, 0, 3);
  Reg32Value = PLBV46_2_WB_ENCONDER_mReadSlaveReg2(baseaddr, 0);
  ...
  PLBV46_2_WB_ENCONDER_mWriteSlaveReg3(baseaddr, 0, 4);
  Reg32Value = PLBV46_2_WB_ENCONDER_mReadSlaveReg3(baseaddr, 0);
  ...
  Reg32Value = PLBV46_2_WB_ENCONDER_mReadReg(baseaddr, PLBV46_2_WB_ENCONDER_INTR_IPISR_OFFSET);
  xil_printf("   - IP (user logic) interrupt status : 0x%08x\n\r", Reg32Value);
  xil_printf("   - clear IP (user logic) interrupt status register\n\r");
  PLBV46_2_WB_ENCONDER_mWriteReg(baseaddr, PLBV46_2_WB_ENCONDER_INTR_IPISR_OFFSET, Reg32Value);
  Reg32Value = PLBV46_2_WB_ENCONDER_mReadReg(baseaddr, PLBV46_2_WB_ENCONDER_INTR_DISR_OFFSET);
  xil_printf("   - Device (peripheral) interrupt status : 0x%08x\n\r", Reg32Value);
  xil_printf("   - clear Device (peripheral) interrupt status register\n\r");
  PLBV46_2_WB_ENCONDER_mWriteReg(baseaddr, PLBV46_2_WB_ENCONDER_INTR_DISR_OFFSET, Reg32Value);
  xil_printf("   - enable all possible interrupt(s)\n\r");
  PLBV46_2_WB_ENCONDER_EnableInterrupt(baseaddr_p);
